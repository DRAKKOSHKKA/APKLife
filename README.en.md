...
- Android Native (Variant B): [android_native/README.en.md](android_native/README.en.md)
...
See: [android_native/README.en.md](android_native/README.en.md)
...
Back to language switch: [README.md](README.md)
